...
SK그룹 계열 제약·바이오 기업. HypeProof Lab의 첫 번째 기업 임직원 가족 교육 프로그램 파트너.

---

## 역할

- 임직원 가족 대상 AI 교육 프로그램 수요처
- 교육 장소 제공 (10층 내부 카페)
- 내부 수요조사 및 프로그램 승인 주체
...
- 내부 업무용 랩탑 사용 불가 → 개인 랩탑 지참 필요
- 공용 인터넷 사용 가능 (접속 속도 사전 확인 필요)
