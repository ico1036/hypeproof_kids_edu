...
따라서 15만원/h는 대치동 소규모 프리미엄보다 높고, UC Riverside급 해외 프리미엄 AI 교육보다 약간 높으며, SK 파일럿 제안가 상단과 일치하는 검증형 프리미엄 가격이다. 컨설팅식 bottom-up 검산으로도 20가족 기준 4시간 매출 1,200만원, 직접 운영비 약 260만~400만원 수준이라 파일럿·파트너 수수료를 감안해도 gross margin이 남는다.
