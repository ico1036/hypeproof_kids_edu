...
- **방법론 라이브러리** (`models/_index.md` 선택 가이드): [[evidence-standards]] · [[m-explicit-instruction]] · [[m-guided-discovery]] · [[m-cognitive-apprenticeship]] · [[m-problem-based-learning]] · [[m-cooperative-learning]] · [[m-formative-feedback]] · [[m-poe]] · [[kr-instructional-models-map]] (국내 모형 지도) · [[kr-models-korean]] · [[kr-models-science]] · [[kr-models-social-moral-math]] · [[kr-models-cooperative]]
